    ...
    <div ref={containerRef} className="relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center pointer-events-none">
        <div className="text-center px-4 pointer-events-auto">
          <h1 ref={titleRef} className="text-7xl md:text-9xl font-bold mb-8 text-white border" style={{ textShadow: '0 0 30px rgba(165, 180, 252, 0.5), 0 0 60px rgba(196, 181, 253, 0.3)' }}>
